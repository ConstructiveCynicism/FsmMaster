...
// IFsmGraphColorConfig wrapper over FsmMasterGlobalSettings' plain Color fields - see that class's own
// comment for why colors are plain fields rather than GetX/SetX-backed properties on this loader.
internal sealed class HK1221GraphColorConfig : IFsmGraphColorConfig
{
    ...
    public HK1221GraphColorConfig(FsmMasterGlobalSettings settings)
    {
