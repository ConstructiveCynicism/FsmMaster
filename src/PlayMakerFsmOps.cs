...
// Minimal stand-in for the FsmUtil extension methods FsmMaster used to pull in from a NuGet package.
...
internal static class PlayMakerFsmOps
{
    ...
    // Deliberately non-interned, matching the existing (pre-port) behavior: this builds a plain
    ...
    // that special case must stay in place once FsmGraphOverlay is ported.
